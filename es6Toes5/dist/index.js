...
$(function () {
  ...
  */
	function generatePagination(element) {
		...
		paginationStr = "<input type=\"text\" class=\"m-p-ipt\" placeholder=\"\u9875\u7801\"><div class=\"m-pagination-item m-p-go\">\u8DF3\u8F6C</div><div class=\"m-pagination-item m-p-prev\">&lt</div>" + pageNumStr + "<div class=\"m-pagination-item m-p-next\">&gt</div>";
